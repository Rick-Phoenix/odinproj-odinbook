...
export function FeaturesSectionDemo() {
  const features = [
    {
      title: "Join groups and discussions about your favorite topics",
      description: "Create, manage and take part in various communities.",
      skeleton: <SkeletonOne />,
      className: "col-span-1 lg:col-span-4 border-b lg:border-r dark:border-neutral-800",
    },
    {
      title: "Monetize your old belonging",
      description: "Sell your items easily while taking advantage of the best deals around.",
    ...
    },
    {
      ...
      description:
        "Nexus comes with an integrated chatting application, where you can discuss privately with other members of the community or discuss with potential sellers or buyers for your favorite items.",
