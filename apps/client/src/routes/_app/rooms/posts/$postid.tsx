    ...
    <section className="min-h-svh rounded-xl bg-muted/50">
      ...
      <div className="p-6">
        ...
        <div className="grid grid-cols-[2.5rem_1fr] items-center">
          <div className="col-start-1 col-end-3 row-span-1 row-start-1 grid grid-cols-[auto_1fr] items-center justify-self-start">
            <div className="col-start-1 row-span-1 row-start-1 h-10 w-10 rounded-full bg-foreground"></div>
